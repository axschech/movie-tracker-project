...
- It took about a day to get the service and DB running in Docker.
- It took about two days to saving user data and to get to querying media.
- It took the rest of the week to get to saving media and saving user media pairings.
